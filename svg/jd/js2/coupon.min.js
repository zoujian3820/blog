...
!function (a) {
    ...
    var b = function () {
        ...
        return b.prototype = {
            init: function (b) {
                ...
                this.settings = a.extend(c, b), this.currentPage = c.currentPage, this.containId = c.containId, this.objContain = document.querySelector(this.containId),
                    this.categoryId = c.categoryId, this.isFirstNormalTab = c.isFirstNormalTab,
                    this.isFirstNormalTab ? this.currentPage = 2 :
                        (1 == this.currentPage && ( /*this.objContain.innerHTML = "",*/ this.getData(1)), this.currentPage = 2), this.events()
            }, scrollFn: function () {
    ...
    M.object.merge(b.prototype, {
        init: function (a) {
            ...
            //"2" == $(a).find(".type").val() ? this.discountPing("MProductCoupon_Specialcoupon", $(a).find(".batchId").val()) : "1" == $(a).find(".type").val() && this.discountPing("MProductCoupon_Coupon", $(a).find(".batchId").val()),
            //    $(a).find(".coupon-btn-yellow").size() > 0 || $(a).find(".coupon-btn-go-look").size() > 0 ? this.couponJumpBind(a) : this.checkLoginAndPayPwd(a)
            ...
            $.loadPage({
                ...
                isFirstNormalTab: b,
                beforeFn: function () {
                    $("#clickChange")[0].getAttribute("style").indexOf("block") != -1 && $(".no-coupon")[0].getAttribute("style").indexOf("block") != -1 || (c.style.display = "block")
                },
    ...
    M.object.merge(b.prototype, {
        init: function (a) {
            ...
            b.appdownInit(c), b.coverPannel = new (M.exports("CoverPannel").clazz)({
                ...
                headData: b.cateData,
                startIndex: $("#beginTab").attr("beginTabIndex") - 1,
                autoScroll: !0,
                showLen: 4,
                marginLen: 0,
                right: 40,
                ...
                callback: function (a) {
                    ...
                    //var c ='bugbug' /*b.cateData[a.index].cateId*/, d = $("#lunboPic"), e = $("#firstCatergryId").val();
                    //if (b.isFirstLoad) {
                    //    var f = !0;
