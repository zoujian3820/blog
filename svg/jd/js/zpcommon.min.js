...
var Zepto = function () {
    ...
    function t(a) {
        try {
            return a ? "true" == a || "false" != a && ("null" == a ? null : +a + "" == a ? +a : /^[\[\{]/.test(a) ? x.parseJSON(a) : a) : a
        } catch (b) {
            return a
        }
    }
    ...
    function u(a, b) {
        b(a);
        for (var c = 0, d = a.childNodes.length; c < d; c++)u(a.childNodes[c], b)
    }
...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function (a) {
    ...
    z.href = window.location.href, a.active = 0, a.ajaxJSONP = function (b, c) {
        ...
        //                try {
        //                    "script" == n ? (0, eval)(b) : "xml" == n ? b = x.responseXML : "json" == n && (b = y.test(b) ? null : a.parseJSON(b))
        //                } catch (d) {
        //                    c = d
        //                }
...
!function (a) {
    ...
    function i(a, b, c, d, e) {
        setTimeout(function () {
            ...
            b.parentNode && (t = b.parentNode), f = document.createElement("script"), b.type && (f.type = b.type), b.charset && (f.charset = b.charset), e ? z ? (a[p] && v("start script preload: " + i), c.elem = f, y ? (f.preload = !0, f.onpreload = d) : f.onreadystatechange = function () {
    ...
    function j() {
        ...
        function s(a, b, c, e) {
            ...
            b.src = d(b.src, a[q]), b.real_src = b.src + (a[o] ? (/\?.*$/.test(b.src) ? "&_" : "?_") + ~~(1e9 * Math.random()) + "=" : ""), D[b.src] || (D[b.src] = {
                items: [],
                finished: !1
            }), g = D[b.src].items, a[n] || 0 == g.length ? (f = g[g.length] = {
                ready: !1,
                finished: !1,
                ready_listeners: [j],
        ...
        var x, y = {}, A = z || B, C = [], D = {};
        return y[l] = !0, y[m] = !1, y[n] = !1, y[o] = !1, y[p] = !1, y[q] = "", x = {
            setGlobalDefaults: function (a) {
                ...
                for (var a, b = x, c = C.length, d = c; --d >= 0;)a = C.shift(), b = b[a.type].apply(null, a.args);
                return b
            }, noConflict: function () {
                return a.JDLAB = k, x
            }, sandbox: function () {
